...
SECRET_KEY = os.environ.get('SECRET_KEY', 'lab-insecure-default-key')
...
# Database
DB_NAME = os.environ.get('DB_NAME', 'sand_fp_db_lab') # Default specific name

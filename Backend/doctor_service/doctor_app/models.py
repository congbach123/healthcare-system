...
class Doctor(models.Model):
    ...
    # Doctor-specific data - ONLY include data NOT in the Identity Service User model
    ...
    def __str__(self):
        # Without calling the Identity Service, we can only show the user_id or license

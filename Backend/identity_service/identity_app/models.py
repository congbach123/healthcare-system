# healthcare_microservices/identity_service/identity_app/models.py
...
class User(AbstractUser):
    ...
    class Meta:
         # Add db_table if you want a specific table name, otherwise Django uses appname_modelname (identity_app_user)
         # db_table = 'identity_users' # Optional

...
class Patient(models.Model):
    ...
    # in the Identity Service. This establishes the link.
    user_id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)

    # Patient-specific data - ONLY include data NOT in the Identity Service User model
    ...
    def __str__(self):
        # Without calling the Identity Service, we can only show the user_id or a generic string

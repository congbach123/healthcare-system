...
SECRET_KEY = os.environ.get('SECRET_KEY', 'presc-insecure-default-key')
...
INSTALLED_APPS = [
    ...
    'prescription_app', # <-- Add your app here
]
...
# Database
DB_NAME = os.environ.get('DB_NAME', 'sand_fp_db_prescription') # Default specific name

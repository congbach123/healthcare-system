...
SECRET_KEY = os.environ.get('SECRET_KEY', 'pharmacist-insecure-default-key')
...
INSTALLED_APPS = [
    ...
    'pharmacist_app', # <-- Add your pharmacist app here
]
...
# Database
DB_NAME = os.environ.get('DB_NAME', 'sand_fp_db_pharmacist') # Default specific name

...
def groupby_transform(iterable, keyfunc=None, valuefunc=None, reducefunc=None):
    ...
    * *reducefunc* is a function that transforms each group of items
    ...
    Each optional argument defaults to an user function if not specified.
...
def consecutive_groups(iterable, ordering=lambda x: x):
    ...
    By default, the ordering function is the user function. This is
...
def map_reduce(iterable, keyfunc, valuefunc=None, reducefunc=None):
    ...
    *valuefunc* defaults to the user function if it is unspecified.
...
def map_if(iterable, pred, func, func_else=lambda x: x):
    ...
    *pred*, *func*, and *func_else* should each be functions that accept
    one argument. By default, *func_else* is the user function.

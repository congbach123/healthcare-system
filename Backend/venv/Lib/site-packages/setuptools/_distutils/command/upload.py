...
class upload(PyPIRCCommand):
    ...
    user_options = PyPIRCCommand.user_options + [
        ...
        ('user=', 'i', 'GPG user used to sign files'),
    ]
    ...
    def finalize_options(self):
        ...
        if self.user and not self.sign:
            raise DistutilsOptionError("Must use --sign for --user to have meaning")
    ...
    def upload_file(self, command, pyversion, filename):  # noqa: C901
        ...
        if self.sign:
            ...
            if self.user:
                gpg_args[2:2] = ["--local-user", self.user]
